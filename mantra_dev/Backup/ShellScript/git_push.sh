...
#Mantra
echo "$(date '+%FT%H:%M:%S') - Starting push Mantra" >> "$LOG_FILE" 2>&1
cd '/home/mantra/mantrastage-bench/apps/mantra/'
bench export-fixtures --app mantra
...
echo "$(date '+%FT%H:%M:%S') - Push done Mantra" >> "$LOG_FILE" 2>&1