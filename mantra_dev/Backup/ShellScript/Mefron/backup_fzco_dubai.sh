...
# Paths
SOURCE_FOLDER="/home/frappe-bench/"
SOURCE_ZIP="/home/mantra/backup/fzco_dubai_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_fzco_dubai.log"
...
echo "[$(date)] Starting backup of fzco dubai $SOURCE_FOLDER" >> "$LOG_FILE"
...
find /home/mantra/backup/ -name 'fzco_dubai_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
