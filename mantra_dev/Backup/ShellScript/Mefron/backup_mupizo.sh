...
# Paths
SOURCE_FOLDER="/home/mupizo/"
SOURCE_ZIP="/home/mantra/backup/mupizo_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_mupizo.log"
...
echo "[$(date)] Starting backup of mupizo $SOURCE_FOLDER" >> "$LOG_FILE"
...
find /home/mantra/backup/ -name 'mupizo_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
