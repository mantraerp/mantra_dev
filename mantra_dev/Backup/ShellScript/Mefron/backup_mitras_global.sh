...
# Paths
SOURCE_FOLDER="/home/mitras_global/"
SOURCE_ZIP="/home/mantra/backup/mitras_global_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_mitras_global.log"
...
echo "[$(date)] Starting backup of mitras globle $SOURCE_FOLDER" >> "$LOG_FILE"
...
find /home/mantra/backup/ -name 'mitras_global_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
