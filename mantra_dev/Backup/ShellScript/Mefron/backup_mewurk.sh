...
# Paths
SOURCE_FOLDER="/home/mewurk/"
SOURCE_ZIP="/home/mantra/backup/mewurk_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_mewurk.log"
...
echo "[$(date)] Starting backup of mewurk $SOURCE_FOLDER" >> "$LOG_FILE"
...
find /home/mantra/backup/ -name 'mewurk_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
