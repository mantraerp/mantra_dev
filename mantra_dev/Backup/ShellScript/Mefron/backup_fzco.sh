...
# Paths
SOURCE_FOLDER="/home/fzco/"
SOURCE_ZIP="/home/mantra/backup/fzco_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_fzco.log"
...
echo "[$(date)] Starting backup of fzco $SOURCE_FOLDER" >> "$LOG_FILE"
...
find /home/mantra/backup/ -name 'fzco_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
