...
# Paths
SOURCE_FOLDER="/home/mantrasmartidentity_india/"
SOURCE_ZIP="/home/mantra/backup/ibu_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_ibu.log"
...
echo "[$(date)] Starting backup of IBU $SOURCE_FOLDER" >> "$LOG_FILE"
...
find /home/mantra/backup/ -name 'ibu_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
