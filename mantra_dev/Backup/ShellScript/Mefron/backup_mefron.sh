...
# Paths
SOURCE_FOLDER="/home/mefron-bench/"
SOURCE_ZIP="/home/mantra/backup/mefron_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_mefron.log"
...
echo "[$(date)] Starting backup of mefron $SOURCE_FOLDER" >> "$LOG_FILE"
...
find /home/mantra/backup/ -name 'mefron_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
