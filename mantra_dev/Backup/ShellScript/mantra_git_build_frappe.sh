...
echo "################  Bench build frappe start $(date +'%Y-%m-%d %H:%M:%S') ###############" >> /home/mantra/mantrastage-bench/logs/gitauto.log 2>&1
cd /home/mantra/mantrastage-bench/apps/
echo $password | sudo -S -k bench build --app frappe
echo "################  Bench build frappe end $(date +'%Y-%m-%d %H:%M:%S') ###############" >> /home/mantra/mantrastage-bench/logs/gitauto.log 2>&1
