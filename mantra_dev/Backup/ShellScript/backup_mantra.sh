...
# Paths
SOURCE_FOLDER="/home/mantra/mantrastage-bench/"
SOURCE_ZIP="/home/mantra/backup/mantra_backup_$DATE.zip"
LOG_FILE="/home/mantra/backup/backup_transfer.log"
...
find /home/mantra/backup/ -name 'mantra_backup_*.zip' -type f ! -name "$(basename "$SOURCE_ZIP")" -exec rm -f {} \;
